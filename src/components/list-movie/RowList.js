import { createRef, useEffect, useReducer, useState, forwardRef } from 'react';
...
const RowList = forwardRef(({ className, data: { payloadType, payloadKey, title, items: defaultItems }, firstRequest = false, ItemComponent, placeholder = false, preview = false }, ref) => {
    ...
    }, [payloadType, payloadKey, placeholder, fetchRequest, dispatch, items.length, loading, error, isEmpty]);
